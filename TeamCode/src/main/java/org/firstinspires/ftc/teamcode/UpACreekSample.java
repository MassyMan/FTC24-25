...
@Config
@Autonomous(name = "UP-A-CREEK AUTO", group = "Autonomous")
public class UpACreekSample extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (hasSpike(colorSensor) || !hasSpike(colorSensor)){
            ...
            // TODO: GRAB FROM HUMAN PLAYER

            Actions.runBlocking(drive.actionBuilder(new Pose2d(-54, -50, Math.toRadians(0))) // DIDN'T GET THIRD BLOCK; GO TO SUBMERSIBLE
                    .afterTime(0, IntakeSubLong)
                    .afterTime(3, OuttakeSample)

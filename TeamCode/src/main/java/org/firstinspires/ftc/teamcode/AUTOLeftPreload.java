...
@Config
@Autonomous(name = "LEFT PRELOAD + PARK", group = "Autonomous")
public class AUTOLeftPreload extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            // SEQUENCE FOR OUTTAKING PRELOAD, LOWERING SLIDES, DRIVING TO PARK LOCATION
